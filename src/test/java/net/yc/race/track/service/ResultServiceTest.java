...
class ResultServiceTest {
    ...
    void showResult_ShouldReturnTop25PercentResults() {
        ...
        Result result2 = new Result(2, 0, "Loft B", "badge2", new Date(), 150.0, 90.0, 0.0, competitionId);
        Result result3 = new Result(3, 0, "Loft C", "badge3", new Date(), 120.0, 85.0, 0.0, competitionId);
        Result result4 = new Result(4, 0, "Loft D", "badge4", new Date(), 130.0, 70.0, 0.0, competitionId);
